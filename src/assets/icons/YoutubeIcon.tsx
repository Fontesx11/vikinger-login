...
const YoutubeLogo: React.FC<YoutubeLogoProps> = ({ className, options }) => (
  <div className={`w-[40px] h-[40px] bg-[#fd434f] flex justify-center items-center rounded-[7px] ${options}`}>
    <svg
      viewBox="0 0 100 100"
