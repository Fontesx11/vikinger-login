...
const TwitterLogo: React.FC<TwitterLogoProps> = ({ className, options }) => (
  <div className={`w-[40px] h-[40px] bg-[#1abcff] flex justify-center items-center rounded-[7px] ${options}`}>
    <svg
      viewBox="-4 -4 26 26"
